 ...
 */ 
 ...
 public class CloudClientConnector implements ICloudClient, IConnectionListener
 {
	 ...
	 private String createTopicName(String deviceName, String resourceTypeName)
	 {
		 ...
		 _Logger.info("Creating topic name for device: " + deviceName + ", resource: " + resourceTypeName);
	 ...
	 private boolean publishMessageToCloud(ResourceNameEnum resource, String deviceID, String itemName, String payload) {
		 if (resource != null && deviceID != null && itemName != null && payload != null) {
			 String topicName = createTopicName(deviceID, resource.getResourceType()) + "-" + itemName;
